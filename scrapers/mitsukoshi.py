...
# 食料品イベントスケジュール専用ページ
EVENT_URL = "https://www.mistore.jp/store/nihombashi/shops/foods/mitsukoshigourmet/event_calendar.html"
STORE = "日本橋三越"
...
def scrape() -> list[Event]:
    ...
    try:
        ...
        print(f"[mitsukoshi] scrape error: {e}", flush=True)
